    ...
    <FadeUp delay={0.1 + index * 0.06}>
      ...
      >
        ...
        <div className={`${colors.bg} border-b ${colors.border} p-5`}>
          ...
          {/* Behavioral target */}
          <p className="text-sm text-gray-600 leading-relaxed font-medium mt-1">{lesson.behavioral_diagnosis}</p>
        ...
        <div className="p-5 border-b border-gray-100 bg-white">
          <div className="flex items-center gap-1.5 mb-2">
            ...
            <span className="text-[11px] font-bold uppercase tracking-wider text-violet-600">Cognitive Coaching</span>
          </div>
          <p className="text-sm text-gray-700 leading-relaxed italic font-medium">&quot;{lesson.cognitive_coaching_narrative}&quot;</p>
        </div>
                    ...
                    <div className={`${CARD} p-6 border-violet-200 bg-violet-50/20 mb-6`}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                        ...
                        <div className="p-4 rounded-xl bg-violet-50 border border-violet-100 md:col-span-2">
                          ...
                          <p className="text-xs text-violet-700 font-semibold">{latestSessionSpecificLesson.personalized_improvement_strategy}</p>
                        </div>
                      </div>
                    </div>
                  </FadeUp>
